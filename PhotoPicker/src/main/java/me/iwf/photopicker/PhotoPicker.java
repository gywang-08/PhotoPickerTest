...
public class PhotoPicker {
  ...
  public final static String KEY_SELECTED_PHOTOS_PATH = "SELECTED_PHOTOS_PATH";
  public final static String KEY_SELECTED_PHOTOS_ID = "SELECTED_PHOTOS_ID";

  public final static String EXTRA_MAX_COUNT       = "MAX_COUNT";
  public final static String EXTRA_SHOW_CAMERA     = "SHOW_CAMERA";
  public final static String EXTRA_SHOW_GIF        = "SHOW_GIF";
  public final static String EXTRA_GRID_COLUMN     = "column";
  public final static String EXTRA_ORIGINAL_PHOTOS_PATH = "ORIGINAL_PHOTOS_PATH";
  public final static String EXTRA_ORIGINAL_PHOTOS_ID = "ORIGINAL_PHOTOS_ID";
  ...
  public static class PhotoPickerBuilder {
    ...
    public PhotoPickerBuilder setSelected(ArrayList<String> imagesUri) {
      mPickerOptionsBundle.putStringArrayList(EXTRA_ORIGINAL_PHOTOS_PATH, imagesUri);
      return this;
    }

    public PhotoPickerBuilder setSelectedId(ArrayList<Integer> imagesId) {
      mPickerOptionsBundle.putIntegerArrayList(EXTRA_ORIGINAL_PHOTOS_ID, imagesId);
      return this;
    }
