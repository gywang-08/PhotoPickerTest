...
public class PhotoPickerFragment extends Fragment {
    ...
    //传入的已选照片
    private ArrayList<String> originalPhotosPath;
    private ArrayList<Integer> originalPhotosId;
    ...
    private final static String EXTRA_ORIGIN_PATH = "origin_path";
    private final static String EXTRA_ORIGIN_ID = "origin_id";
    ...
    public static PhotoPickerFragment newInstance(boolean showCamera, boolean showGif,
                                                  ...
                                                  ArrayList<String> originalPhotosPath,
                                                  ArrayList<Integer> originalPhotosId) {
        ...
        args.putStringArrayList(EXTRA_ORIGIN_PATH, originalPhotosPath);
        args.putIntegerArrayList(EXTRA_ORIGIN_ID,originalPhotosId);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        originalPhotosPath = getArguments().getStringArrayList(EXTRA_ORIGIN_PATH);
        originalPhotosId = getArguments().getIntegerArrayList(EXTRA_ORIGIN_ID);
        ...
        photoGridAdapter = new PhotoGridAdapter(getActivity(), mGlideRequestManager, directories, originalPhotosPath,originalPhotosId, column);
        ...
        photoGridAdapter.setOnPhotoClickListener(new OnPhotoClickListener() {
            ...
            public void onClick(View v, int position, boolean showCamera) {
                ...
                if (Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.Q) {
                    List<Integer> ids = photoGridAdapter.getCurrentPhotoIDs();

                    ImagePagerFragment imagePagerFragment =
                            ImagePagerFragment.newInstancebyID(ids, index);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == ImageCaptureManager.REQUEST_TAKE_PHOTO && resultCode == RESULT_OK) {
            ...
            if (directories.size() > 0) {
                ...
                if (Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.Q) {
                    int id = captureManager.getCurrentPhotoID();
                    PhotoDirectory directory = directories.get(INDEX_ALL_PHOTOS);
                    directory.getPhotos().add(INDEX_ALL_PHOTOS, new Photo(id));
                    directory.setCoverID(id);
