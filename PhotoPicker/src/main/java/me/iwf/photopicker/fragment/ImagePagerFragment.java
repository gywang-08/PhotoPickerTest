...
public class ImagePagerFragment extends Fragment {
    ...
    public static ImagePagerFragment newInstancebyID(List<Integer> ids, int currentItem) {

        ImagePagerFragment f = new ImagePagerFragment();

        Bundle args = new Bundle();

        args.putIntegerArrayList(ARG_ID, (ArrayList<Integer>) ids);
        args.putInt(ARG_CURRENT_ITEM, currentItem);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            if (Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.Q) {
                ...
                //ids.clear();
                ids = bundle.getIntegerArrayList(ARG_ID);
            }else {
        ...
        mPagerAdapter = new PhotoPagerAdapter(Glide.with(this), paths,ids);
    ...
    public ArrayList<Integer> getCurrentID() {
