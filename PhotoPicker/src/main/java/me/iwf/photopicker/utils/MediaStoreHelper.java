...
//    Cursor data = activity.getContentResolver().query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI,
//            null,null,null,android.provider.MediaStore.MediaColumns._ID + " DESC");
        Cursor data = activity.getContentResolver().query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI,
                null, null, null, null);
        ...
        photoDirectoryAll.setName(activity.getString(R.string.__picker_all_image));
        ...
        while (data.moveToNext()) {
            ...
            int imageId = data.getInt(data.getColumnIndexOrThrow(_ID));//图片ID
            String bucketId = data.getString(data.getColumnIndexOrThrow(BUCKET_ID));//相册id
            String name = data.getString(data.getColumnIndexOrThrow(BUCKET_DISPLAY_NAME));//相册名
            String path = data.getString(data.getColumnIndexOrThrow(DATA));//图片路径
            long size = data.getInt(data.getColumnIndexOrThrow(SIZE));//图片大小
            ...
            if (!directories.contains(photoDirectory)) {
                ...
                photoDirectory.setCoverID(imageId);
